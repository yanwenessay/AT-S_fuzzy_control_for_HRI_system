...
def parseConnectionArguments(parser = argparse.ArgumentParser()):
    parser.add_argument("--ip", type=str, help="IP address of destination", required=True)
    parser.add_argument("-u", "--username", type=str, help="username to login", required=True)
    parser.add_argument("-p", "--password", type=str, help="password to login", required=True)
